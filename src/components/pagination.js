...
const PrevButton = ({ currentPage, handlePageChange }) => {
  return (
    <button
      ...
      className={clsx(
        'flex items-center cursor-pointer justify-center w-[44px] h-[44px] text-black disabled:opacity-50 disabled:cursor-not-allowed',
...
export const NextButton = ({ currentPage, handlePageChange, totalPages }) => {
  return (
    <button
      ...
      className={clsx(
        'flex cursor-pointer items-center justify-center w-[44px] h-[44px] text-black disabled:opacity-50 disabled:cursor-not-allowed',
...
const PaginationButton = ({ currentPage, page, handlePageChange }) => {
  return (
    <button
      ...
      className={clsx(
        'flex items-center cursor-pointer justify-center w-[44px] h-[44px] text-[17px] font-medium leading-[140%]',
    ...
    <div className="flex justify-center mb-[40px]">
      <div className="flex">
        ...
        {getPageNumbers().map((page, index) => (
          <PaginationButton key={`page-${index}`} currentPage={currentPage} page={page}
